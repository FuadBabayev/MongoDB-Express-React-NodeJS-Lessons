...
// * express.json() used for get acces to the request.body
...
// ! we firstly need middleware "app.use(express.json())" in order to set POST method (get acces to the request.body)
